...
player createDiaryRecord [
	...
	[
		...
		<br/>1. CAS call-ins must be typed into Side Channel with a specific position or target, no exceptions.
...
player createDiaryRecord [
	...
	[
		'Comms',
		"
		<br /><br />1. Spamming comms will not be tolerated
		<br /><br />2. Arguing on comms will not be tolerated
		<br /><br />3. Shouting/Screaming on comms will not be tolerated. (This includes telling a pilot they suck and can not fly to save their own life)
		<br /><br />4. Speaking on Global or Side will result in a kick, and if done again a ban will be issued.
		<br /><br />5. Speaking over side is laggy and no-one can understand you. Type on side. Talk in Group or better join us on TS
		<br /><br />6. Excessive mic spam will result in a kick, if done again a ban will be issued
		"
	]
];
...
player createDiaryRecord [
	...
	'Mods Allowed',
	"
	<br />* Client-Side Mods Allowed:
	<br/><br/>- Dynasound 2 (Audio effects mod)
	<br/>- Enhanced Soundscape (Audio effects mod)
	<br/><br/>- Blastcore standalone (Visual effects mod)
	<br/>- Sullen Skies Altis, Stratis, Malden and Tanoa (Visual effects mod)
	<br/>- Dynamic View Distance by Lawrence (Visual effects mod)
	<br/>- CH View Distance (Visual effects mod)
	<br/><br/>- ShackTack HUD (Gameplay enhancement mod)
	<br/>- Reduced Weapon Sway (Gameplay enhancement mod)
	<br/>- Kimi's HMD MOD (Gameplay enhancement mod)
	<br/><br/>- CBA_A3 (Core mod)
	<br/>- Achilles (Zeus enhancement mod)
	<br/><br/><br/>* Server-Side Mods:
	<br/><br/>- Advanced Urban Rappelling (Gameplay enhancement mod)
	<br/>- Advanced Towing (Gameplay enhancement mod)
	<br/><br/><br/>* Integrated Mods:
	<br/><br/>- Advanced Rappelling (Gameplay enhancement mod)
	<br/>- Advanced Sling-Loading (Gameplay enhancement mod)
	<br/>- QS Mag Repack (Gameplay enhancement mod)
	"
	]
];
