...
air_vehicles = [
	...
	["uns_A1J_CAS",900,600,600],
			//A-1H Skyraider (CAS)	["UNS_skymaster_CAS",1000,500,500],
			//O-2A Skymaster (CAS)
...
support_vehicles = [
	...
	["ACE_Wheel",10,0,0],
	["ACE_Track",10,0,0],
	["uns_nvatruck_repair",325,0,75],									//Ural Repair
	["uns_nvatruck_refuel",125,0,275],										//Ural Fuel
	["uns_nvatruck_reammo",125,200,75],									//Ural Ammo
