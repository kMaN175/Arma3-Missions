...
KP_liberation_little_bird_classname = "UK3CB_BAF_Wildcat_AH1_TRN_8A";   // These are the little birds which spawn on the Freedom or at Chimera base.
...
light_vehicles = [
    ...
    ["UK3CB_BAF_LandRover_WMIK_Milan_FFR_Green_B",275,60,150],          // milan
    ["CUP_B_MTVR_USMC",125,0,75],                                       // MTVR Transport
	["B_Boat_Transport_01_F",50,0,25],									// assault boat
	["B_Boat_Transport_01_F",75,50,50],									// raid boat gpmg
	["B_Boat_Transport_01_F",120,50,50],								// raid boat hmg
	["CUP_B_MK10_GB",200,200,200]										// landing craft
...
air_vehicles = [
	...
	["B_Heli_Light_01_F",200,0,100],									// little bird unarmed
	["RHS_MELB_AH6M",200,200,100],										// socom little bird armed
	...
	["CUP_B_SA330_Puma_HC2_BAF",225,0,125],								// SA330 Puma
