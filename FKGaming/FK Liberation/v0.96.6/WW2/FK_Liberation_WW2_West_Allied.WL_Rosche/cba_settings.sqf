...
force TFAR_giveLongRangeRadioToGroupLeaders = true;
...
force TFAR_setting_DefaultRadio_Airborne_Independent = "B_LIB_US_Radio";
force TFAR_setting_DefaultRadio_Airborne_West = "B_LIB_US_Radio";
force TFAR_setting_DefaultRadio_Backpack_east = "";
force TFAR_setting_DefaultRadio_Backpack_Independent = "B_LIB_US_Radio";
force TFAR_setting_DefaultRadio_Backpack_west = "B_LIB_US_Radio";
force TFAR_setting_DefaultRadio_Personal_east = "";
force TFAR_setting_DefaultRadio_Personal_Independent = "fow_b_us_radio_scr";
force TFAR_setting_DefaultRadio_Personal_West = "fow_b_us_radio_scr";
force TFAR_setting_DefaultRadio_Rifleman_East = "";
force TFAR_setting_DefaultRadio_Rifleman_Independent = "fow_b_us_radio_scr";
force TFAR_setting_DefaultRadio_Rifleman_West = "fow_b_us_radio_scr";
force TFAR_spectatorCanHearEnemyUnits = false;
force TFAR_spectatorCanHearFriendlies = true;
force TFAR_takingRadio = 1;
force TFAR_Teamspeak_Channel_Name = "Liberation TFAR";
