...
GRLIB_fob_range = 120;                                                  // Build range around the main FOB building.
...
GRLIB_recycling_percentage = 0.40;                                      // Percentage of resources you get back from recycling.
KP_liberation_production_interval = 45;                                 // Time in minutes until a production process is finished, when resources multiplier is set to 1.
...
GRLIB_civilians_amount = 7;                                             // Civilian count multiplier.
...
KP_liberation_civinfo_min = 5000;                                       // Civil Informant minimum spawn time. (seconds)
KP_liberation_civinfo_max = 10000;                                      // Civil Informant maximum spawn time. (seconds)
KP_liberation_civinfo_chance = 70;                                      // Civil Informant spawn chance. (0-100)
...
KP_liberation_convoy_ambush_chance = 3;                                 // Chance that a logistic convoy will be ambushed, when civil reputation is low.
KP_liberation_convoy_ambush_duration = 1000;                            // Duration of the convoy ambush event. (seconds)

KP_liberation_resistance_tier2 = 25;                                    // At which strength (0-100) the guerilla forces will be at tier 2?
KP_liberation_resistance_tier3 = 65;                                    // At which strength (0-100) the guerilla forces will be at tier 3?
...
box_transport_config = [
	...
	["O_CUPONK_Ural_Open",  -6.5, [0,-0.5,0], [0,-2.5,0]],
	...
	["O_CUPONK_Ural_Open", -6.5, [0,-0.2,0.55], [0,-1.4,0.55], [0,-2.55,0.55]],
