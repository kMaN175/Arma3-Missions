...
opfor_squad_leader = "uns_men_VC_mainforce_68_COM";							//Squad Leader
...
opfor_grenadier = "uns_men_NVA_68_MTS";									//Grenadier
...
opfor_sharpshooter = "uns_men_VC_mainforce_68_MRK";							//Sharpshooter
opfor_sniper = "uns_men_VC_mainforce_RF5";									//Sniper
opfor_at = "uns_men_VC_mainforce_68_AT";									//AT Specialist
opfor_aa = "uns_men_NVA_68_AA";											//AA Specialist
opfor_medic = "uns_men_VC_mainforce_68_MED";								//Combat Life 
opfor_engineer = "uns_men_NVA_68_SAP";										//Engineer
opfor_paratrooper = "uns_nvaf_pilot5";										//Paratrooper

// Enemy vehicles used by secondary objectives.
opfor_mrap = "uns_Type55_RR73";												//Ifrit
opfor_mrap_armed = "uns_Type55_RR73";									//Ifrit (HMG)
