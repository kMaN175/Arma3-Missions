...
1 = Cstom arsenal preset (edit the custom.sqf in the arsenal_presets\ folder to change things for your own versions and tweaks).
...
GRLIB_fob_range = 130;																			// Build range around the main FOB building.
...
GRLIB_capture_size = 180;																		// Range to capture a sector.
...
GRLIB_vulnerability_timer = 1000;																	// Time in seconds how long a captured sector is vulnerable to enemy troops.
...
KP_liberation_cr_building_penalty = 40;																	// Civil Reputation penalty for destroying/damaging a building.
KP_liberation_cr_vehicle_penalty = 30;																	// Civil Reputation penalty for stealing a civilian vehicle.
KP_liberation_cr_resistance_penalty = 40;																// Civil Reputation penalty for killing a friendly resistance soldier.
...
KP_liberation_civinfo_max = 10000;																	// Civil Informant maximum spawn time. (seconds)
KP_liberation_civinfo_chance = 60;																	// Civil Informant spawn chance. (0-100)
KP_liberation_civinfo_intel = 15;																	// Civil Informant intel amount.
KP_liberation_civinfo_duration = 1000;																	// Civil Informant staytime until despawning. (seconds)
...
KP_liberation_convoy_ambush_duration = 500;																// Duration of the convoy ambush event. (seconds)

KP_liberation_resistance_tier2 = 40;																	// At which strength (0-100) the guerilla forces will be at tier 2?
...
KP_liberation_resistance_sector_chance = 25;																// Chance that a guerilla squad will join an ongoing sector attack.
...
box_transport_config = [
	...
	// Additional
	["UK3CB_BAF_MAN_HX58_Cargo_Green_A", -4.5, [0.8,4.6,-0.52], [-0.7,4.6,-0.52], [0.8,3.0,-0.52], [-0.7,3.0,-0.52], [0.8,1.4,-0.52], [-0.7,1.4,-0.52], [0.8,-0.3,-0.52], [-0.7,-0.3,-0.52]]
];
