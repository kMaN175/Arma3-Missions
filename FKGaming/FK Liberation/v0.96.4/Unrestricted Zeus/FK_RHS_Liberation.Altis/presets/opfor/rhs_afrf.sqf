...
militia_squad = [
	...
	"rhs_msv_aa",														//Rifleman (AA)
	"rhs_msv_at",														//Rifleman (AT)
	"rhs_msv_arifleman",												//Autorifleman
	"rhs_msv_engineer",													//Engineer
	"rhs_msv_grenadier_rpg",											//Grenadier (RPG)
	"rhs_msv_marksman",													//Marksman
	"rhs_msv_medic",													//Medic
	"rhs_mvd_izlom_marksman_vss",										//Marksman VSS
	"rhs_mvd_izlom_rifleman_asval",										//Rifleman ASVAL
	"rhs_vmf_recon_rifleman_asval",										//Rifleman ASVAL
	"rhs_vmf_recon_rifleman_scout_akm",									//Rifleman suppressor
	"rhs_vmf_recon_efreitor"											//Rifleman suppressor
];

// Militia vehicles. Lightweight vehicle classnames the game will pick from randomly as sector defenders.
militia_vehicles = [
	"rhs_tigr_sts_msv",													//GAZ-233014 (Armed)
	"rhs_tigr_sts_3camo_msv",											//GAZ-233014 (camo'd)
...
opfor_choppers = [
	...
	"RHS_Ka52_vvsc",													//Ka-52
	"rhs_ka60_grey",													//KA60
	"RHS_Mi8MTV3_heavy_vvs",											//MI8 heavy
	"rhs_mi28n_vvs",													//MI28
	"rhs_mi28n_vvsc",													//MI28
	"rhs_ka60_c",														//KA60
...
opfor_air = [
	...
	"rhs_mig29sm_vvsc",													//mig
	"rhs_mig29s_vvsc",													//mig
	"RHS_T50_vvs_generic"												//T50
];
