...
militia_squad = [
	...
	"O_Soldier_AA_F",												//AA Specialist
	"O_ghillie_ard_F",												//Sniper
	"O_ghillie_sard_F"												//Sniper
];

// Militia vehicles. Lightweight vehicle classnames the game will pick from randomly as sector defenders.
militia_vehicles = [
	"O_LSV_02_armed_F",												//Qilin (armed)
	"O_UGV_01_rcws_F"												//UGV Drone
];
...
opfor_battlegroup_vehicles_low_intensity = [
	...
	"O_Heli_Light_02_dynamicLoadout_F",							//Po-30 Orca (Armed)
	"O_Heli_Transport_04_bench_F",								//Mi-290 Taru (Bench)
	"O_Heli_Transport_04_covered_F"								//Mi-9290 Taru (transport)
];
...
opfor_air = [
	...
	"O_Plane_Fighter_02_Stealth_F",								//Stealth
	"sab_SU34_O",												//SU-34
