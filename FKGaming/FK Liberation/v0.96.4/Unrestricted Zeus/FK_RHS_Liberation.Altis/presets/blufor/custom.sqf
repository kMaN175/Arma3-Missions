...
infantry_units = [
	["rhsusf_army_ocp_riflemanl",15,5,0],								//Rifleman (Light)
	["rhsusf_army_ocp_rifleman",20,5,0],								//Rifleman
	["rhsusf_army_ocp_riflemanat",30,15,0],								//Rifleman (AT)
	["rhsusf_army_ocp_grenadier",25,10,0],								//Grenadier
	["rhsusf_army_ocp_autorifleman",25,5,0],							//Autorifleman
	["rhsusf_army_ocp_machinegunner",35,5,0],							//Heavygunner
	["rhsusf_army_ocp_marksman",30,5,0],								//Marksman
	["rhsusf_army_ocp_javelin",50,10,0],								//AT Specialist
	["rhsusf_army_ocp_aa",50,10,0],										//AA Specialist
	["rhsusf_army_ocp_medic",30,5,0],									//Combat Life Saver
	["rhsusf_army_ocp_engineer",30,5,0],								//Engineer
	["rhsusf_army_ocp_explosives",30,5,0],								//Explosives Specialist
	["rhsusf_usmc_recon_marpat_wd_rifleman",20,5,0],					//Recon Rifleman
	["rhsusf_usmc_recon_marpat_wd_rifleman_at",30,5,0],					//Recon Rifleman (AT)
	["rhsusf_usmc_recon_marpat_wd_autorifleman",25,5,0],				//Recon Autorifleman
	["rhsusf_usmc_recon_marpat_wd_machinegunner",35,10,0],				//Recon Machine Gunner
	["rhsusf_usmc_recon_marpat_wd_marksman",30,5,0],					//Recon Marksman
...
air_vehicles = [
	...
	["I_Plane_Fighter_03_dynamicLoadout_F",500,800,500],				//A-143 Buzzard
	["B_Plane_CAS_01_dynamicLoadout_F",1000,800,500],					//A-164 Wipeout (CAS)
	["RHS_A10",1000,1000,400],											//A-10A (CAS)
	["I_Plane_Fighter_04_F",1000,1200,400],								//A-149 Gryphon
	["FIR_F15SE_Reaper",1250,1250,450],									//F-15SE Silent Eagle
	["JS_JC_FA18E",1500,1750,450],										//F/A-18 E Super Hornet
	["JS_JC_FA18F",1500,1750,450],										//F/A-18 F Super Hornet
	["B_Plane_Fighter_01_F",1500,1750,450],								//F/A-181 Black Wasp II
	["B_Plane_Fighter_01_Stealth_F",1500,1750,450],						//F/A-181 Black Wasp II (Stealth)
	["B_T_VTOL_01_armed_F",800,1500,9000],								//V-44 X Blackfish (Armed)
	["B_T_VTOL_01_infantry_F",800,0,900],								//V-44 X Blackfish (Infantry)
	["B_T_VTOL_01_vehicle_F",800,0,900],								//V-44 X Blackfish (Vehicle)
	["FIR_F14D_VF101_D163",900,900,900],								//F14D dual seater
	["RHS_C130J",250,0,250],											//C130
	["FIR_AV8B_NA",900,900,900]											//Harrier
];
...
static_vehicles = [
	...
	["UK3CB_B_M240_Nest",50,100,0],										//MG NEST
	["UK3CB_B_M240_Nest_Des",50,100,0]									//MG NEST DESERT
];
...
buildings = [
	...
	["ACE_medicalSupplyCrate",10,0,0],
	["UK3CB_BAF_Box_Medical_Supplies",10,0,0],
...
support_vehicles = [
	...
	["UK3CB_BAF_MAN_HX58_Cargo_Green_A",50,50,50],									//Cargo Truck
	["rhsusf_M1078A1R_SOV_M2_D_fmtv_socom",50,0,150],								//SOV fuel truck
	["UK3CB_BAF_MAN_HX58_Repair_Green",150,150,150],								//Man repair truck
	["Redd_Tank_Fuchs_1A4_San_Flecktarn",100,0,100],								//medical vic
	["Redd_Tank_LKW_leicht_gl_Wolf_Flecktarn_San",100,0,100]						//medical vic
];
