...
while {true} do {
	...
	if ((_fobdistance < _distredeploy || (player distance startbase) < 200) && alive player && vehicle player == player && GRLIB_halo_param > 0 && ((count (allPlayers - entities "HeadlessClient_F")) < 65)) then {
