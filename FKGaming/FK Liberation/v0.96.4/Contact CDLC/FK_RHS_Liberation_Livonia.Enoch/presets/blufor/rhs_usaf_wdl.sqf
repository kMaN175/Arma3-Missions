...
infantry_units = [
	...
	["rhsusf_usmc_marpat_wd_rifleman_m4",20,0,0],								//Rifleman
	["rhsusf_usmc_marpat_wd_smaw",30,0,0],								//Rifleman (AT)
	["rhsusf_usmc_marpat_wd_grenadier",25,0,0],								//Grenadier
	["rhsusf_usmc_marpat_wd_autorifleman_m249",25,0,0],							//Autorifleman
	...
	["rhsusf_navy_sarc_w_fast",30,0,0],									//Combat Life Saver
	["rhsusf_usmc_wd_engineer",30,0,0],								//Engineer
	["rhsusf_usmc_wd_explosives",30,0,0],								//Explosives Specialist
	...
	["rhsusf_usmc_marpat_wd_sniper",70,5,0],									//Sniper
	["rhsusf_usmc_marpat_wd_sniper_M107",70,5,0],								//Sniper (M107)
	["rhsusf_usmc_marpat_wd_crewman",10,0,0],							//Crewman
