...
Useless if you're using anything other than "kp_liberation_arsenal = 7;" above. A whitelisted arsenal is always more performance friendly then a blacklisted arsenal.
