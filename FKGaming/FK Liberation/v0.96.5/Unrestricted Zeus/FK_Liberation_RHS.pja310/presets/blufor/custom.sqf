...
light_vehicles = [
	...
	["Redd_Tank_Wiesel_1A2_Tow_Tropentarden",200,200,100],              // RednTank Wiesel TOW (kMaN)
	["Redd_Tank_Wiesel_1A2_Mk20_Tropentarden",200,100,100],             // RednTank Wiesel HMG (kMaN)
	["Redd_Tank_LKW_leicht_gl_Wolf_Tropentarden_FueFU",100,100,100],    // RednTank Car (kMaN)
	["Redd_Tank_LKW_leicht_gl_Wolf_Tropentarden_FJg",100,100,100],      // RednTank Car (kMaN)
	["Redd_Tank_LKW_leicht_gl_Wolf_Tropentarden_San",100,100,100],      // RednTank Car (kMaN)
	["Redd_Tank_LKW_leicht_gl_Wolf_Tropentarden_Moerser",100,100,100]   // RednTank Car (kMaN)
];
...
heavy_vehicles = [
	...
	["Redd_Marder_1A5_Tropentarn",550,550,250],                         // RednTank Marder (kMaN)
	["Redd_Tank_Fuchs_1A4_San_Tropentarn",300,150,150],                 // RednTank Fuchs Medical (kMaN)
	["Redd_Tank_Fuchs_1A4_Jg_Milan_Tropentarn",300,200,150],            // RednTank Fuchs Milan (kMaN)
	["Redd_Tank_Fuchs_1A4_Jg_Tropentarn",200,150,150],                  // RednTank Fuchs (kMaN)
	["Redd_Tank_Fuchs_1A4_Pi_Tropentarn",200,150,150],                  // RednTank Fuchs (kMaN)
	["Redd_Tank_Geopard_1A2_Tropentarden",400,300,200],                 // RednTank Fuchs (kMaN)
	["rnt_sppz_2a2_luchs_Tropentarn",200,150,150]                       // RednTank Fuchs (kMaN)
];
...
support_vehicles = [
	...
	["rnt_lkw_5t_mil_gl_kat_i_transport_trope",100,100,100],            // RednTank Transport Truck (kMaN)
	["rnt_lkw_5t_mil_gl_kat_i_fuel_trope",100,100,300],                 // RednTank Fuel Truck (kMaN)
	["rnt_lkw_7t_mil_gl_kat_i_mun_trope",100,500,100],                  // RednTank Ammo Truck (kMaN)
	["rnt_lkw_7t_mil_gl_kat_i_transport_trope",100,100,100],            // RednTank Transport Truck (kMaN)
	["rnt_lkw_7t_mil_gl_kat_i_repair_trope",350,500,100]                // RednTank Reapir Truck (kMaN)
];
