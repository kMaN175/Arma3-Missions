...
Useless if you're using anything other than "kp_liberation_arsenal = 10;" above. A whitelisted arsenal is always more performance friendly then a blacklisted arsenal.
