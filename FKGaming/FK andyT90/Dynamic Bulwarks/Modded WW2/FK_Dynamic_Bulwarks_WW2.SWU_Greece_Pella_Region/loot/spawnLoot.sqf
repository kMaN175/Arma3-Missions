					...
					if (LOOT_WHITELIST_MODE != 1) then {
						switch (floor random 5) do {
							case 0: {
								...
								_lootHolder addMagazineCargoGlobal [selectRandom _ammoArray, 3 + (floor random 2)];
...
/* Supply Drop */
[bulwarkCity, ["<t color='#00ff00'>" + "FILL AMMO", "supports\ammoDrop.sqf","",2,true,false,"true","true",4], "LIB_Pe2"] remoteExec ["supports_fnc_supplyDrop", 2];
