...
force force ace_advanced_fatigue_performanceFactor = 2.21677;
force force ace_advanced_fatigue_recoveryFactor = 1.84013;
...
force force ace_common_checkPBOsWhitelist = "[bettinv_main_ace,bettinv_main,OCAP,VCOM_AI,SA_AdvancedTowing,darkmap_ace_main,zeus_keybinds_main,RV_ReverseThrust,Tracer_C_F,Tracer_ASBE,gcam,PLP_hidePasswords,PLP_commonModData,tfar_ace_extended_main,CrowsZA,DIS_enhanced_map_ace,simplesuppress_suppress,Ca,fxp_adat,fxp_VehExpEffect,fxp_VehExpEffectBig,fxp_VehHeli,fxp_VehPlane,WarFXPE_Weps,fxp_VehTank,blast_refract,WarFXPE,simplesuppress_main,zeus_additions_main,dwyl_main,tao_rewrite_main,Revo_EP,no_actions_main,AB_WindowBreaker_main,Vile_HUD,3den_inventory_manager,3denEnhanced,BCTracers_Edited,BCTracers_Edited_ace,BCTracers_Edited_hlc,BCTracers_Edited_rhs,Blastcore_MainCore,Blastcore_SmokeCS,Blastcore_Sun,Blastcore_VEP,compositions_a3,DynaSound_DS_a_Blackhawk,DynaSound_DS_a_Chinook,DynaSound_DS_a_Comanche,DynaSound_DS_a_Kajman,DynaSound_DS_a_Kasatka,DynaSound_DS_a_Littlebird,DynaSound_DS_a_Lynx,DynaSound_DS_a_Merlin,DynaSound_DS_a_Taru,DynaSound_DS_a_Xiang,DynaSound_DS_lv_HatchBackSport,DynaSound_DS_m_Bullets,DynaSound_DS_m_Explosions,DynaSound_DS_main,DynaSound_DS_sys,DynaSound_DS_w_120mm,DynaSound_DS_w_155mm,DynaSound_DS_w_20mmgatling,DynaSound_DS_w_30mmgatling,DynaSound_DS_w_4Five,DynaSound_DS_w_AA,DynaSound_DS_w_AK12,DynaSound_DS_w_AKM,DynaSound_DS_w_AKS,DynaSound_DS_w_ASRAAM,DynaSound_DS_w_Alamut,DynaSound_DS_w_Autocannon,DynaSound_DS_w_CAR95,DynaSound_DS_w_CMR76,DynaSound_DS_w_CoaxMG,DynaSound_DS_w_Cyrus,DynaSound_DS_w_DAGR,DynaSound_DS_w_EBR,DynaSound_DS_w_EMR,DynaSound_DS_w_F2000,DynaSound_DS_w_GMG,DynaSound_DS_w_Gau8,DynaSound_DS_w_HMG,DynaSound_DS_w_Katiba,DynaSound_DS_w_Kir,DynaSound_DS_w_LRR,DynaSound_DS_w_Launcher_Big,DynaSound_DS_w_Launcher_Small,DynaSound_DS_w_Lynx,DynaSound_DS_w_M14,DynaSound_DS_w_MAR10,DynaSound_DS_w_MINIGUN65,DynaSound_DS_w_MINIGUN762,DynaSound_DS_w_MK200,DynaSound_DS_w_MLRS,DynaSound_DS_w_MX,DynaSound_DS_w_Navid,DynaSound_DS_w_P07,DynaSound_DS_w_PCML,DynaSound_DS_w_PDW2000,DynaSound_DS_w_PlaneLaunchers,DynaSound_DS_w_Protector,DynaSound_DS_w_RPG7,DynaSound_DS_w_Rahim,DynaSound_DS_w_SDAR,DynaSound_DS_w_SPAR,DynaSound_DS_w_SPAR762,DynaSound_DS_w_SPMG,DynaSound_DS_w_Scalpel,DynaSound_DS_w_Shared,DynaSound_DS_w_SkyFire,DynaSound_DS_w_Sting,DynaSound_DS_w_Tails,DynaSound_DS_w_Tavor,DynaSound_DS_w_Titan,DynaSound_DS_w_Type115_1,DynaSound_DS_w_Type115_2,DynaSound_DS_w_UGL,DynaSound_DS_w_Vermin,DynaSound_DS_w_Zafir,DynaSound_DS_w_Zubr,DynaSound_DS_w_acpc2,DynaSound_DS_w_lim,DynaSound_DS_w_rook,FEINTacLightsSwitch,L_Align_Align_main,L_Align_Align_sys,L_ES_ES_main,L_ES_ES_sounds,L_ES_ES_sys,L_Immerse_Immerse_main,L_Immerse_Immerse_sys,L_Suppress_Suppress_main,L_Suppress_Suppress_sys,SA_AdvancedSlingLoading,UPSL_aime,UPSL_aime_change_ammo,UPSL_aime_group,UPSL_aime_inventory,UPSL_aime_uav_terminal,UPSL_aime_vehicle_controls,UPSL_aime_vehicle_seats,UTGX_Compass,WP_Mod,ace_tracers,ar_advancedrappelling,asw_main,aur_advancedurbanrappelling,ausmd_custom_compositions,awm_ace_actions,awm_main,awm_sys,big_compass,blastcore_extended_fire,blastcore_vanilla_smoke,cine_addizeus_ace_actions,cine_addizeus_ai,cine_addizeus_common,cine_addizeus_gear,cine_addizeus_main,cine_addizeus_vehicles,cine_uavkeybinds_UAV,cine_uavkeybinds_main,cine_uavkeybinds_misc,clib,cup_terrains_ace_compat,cw_9liners_and_notepad,darth_potatos_building_templates,disable_xeh_logging,discord,ds_obe,ds_obe_layer,dxx_comps,feintvtolflapscontrolsmod,fkframework,gf_enhancedvideo,gf_recolor,headrangeplus,hopecore,jsrs_soundmod_boats,jsrs_soundmod_bullethits,jsrs_soundmod_cfg_rhs_afrf_air_vehicles,jsrs_soundmod_cfg_rhs_afrf_vehicles,jsrs_soundmod_cfg_rhs_afrf_weapons,jsrs_soundmod_cfg_rhs_usf_air_vehicles,jsrs_soundmod_cfg_rhs_usf_vehicles,jsrs_soundmod_cfg_rhs_usf_weapons,jsrs_soundmod_complete_edition,jsrs_soundmod_complete_edition_soundfiles,jsrs_soundmod_environment,jsrs_soundmod_explosions,jsrs_soundmod_framework,jsrs_soundmod_helicopters,jsrs_soundmod_landvehicles,jsrs_soundmod_movement,jsrs_soundmod_rhs_afrf_weapons,jsrs_soundmod_rhs_gref_weapons,jsrs_soundmod_rhs_saf_weapons,jsrs_soundmod_rhs_usf_weapons,jsrs_soundmod_sonic_cracks,jsrs_soundmod_weapons,kka3_gestures,kka3_gestures_ace,mrb_a3_airvisibility,mrb_a3_seavesselvisibility,mrb_a3_vehiclevisibility,pfwd_customcompositions,pzc,ri65b,vana,vi_blufor,vphud,zec,zeccup,zei]";
...
force force grenades_hatches_main_allowedGrenadesSetting = "['HandGrenade','MiniGrenade','vn_v40_greande_mag','vn_t67_greande_mag','vn_m18_yellow_mag','vn_m18_white_mag','vn_m18_red_mag','vn_m18_purple_mag','vn_m18_green_mag','vn_rkg3_grenade_mag','vn_rgd5_grenade_mag','vn_rgd33_grenade_mag','vn_rg42_grenade_mag','vn_rdg2_mag','vn_m7_grenade_mag','vn_m67_grenade_mag','vn_m61_grenade_mag','vn_m34_grenade_mag','vn_m14_grenade_mag','vn_m14_early_grenade_mag','vn_f1_grenade_mag','vn_chicom_grenade_mag','vn_molotov_greande_mag']";
...
force force ace_hearing_earplugsVolume = 0.567105;
...
force ace_rearm_distance = 40;
force ace_rearm_level = 0;
force ace_rearm_supply = 0;
force ace_refuel_hoseLength = 24;
...
// Check LOS
MF_los_tool_cellCount = 10000;
MF_los_tool_enabled = true;
MF_los_tool_observerHeight = 1.8;
MF_los_tool_profileEnabled = true;
...
force grad_trenches_functions_bigEnvelopeRemovalTime = 20;
...
force grad_trenches_functions_vehicleEnvelopeRemovalTime = 30;
...
// VCOM AI East Skill
Vcm_AISkills_East_AimingAccuracy = 0.2;
Vcm_AISkills_East_aimingShake = 0.2;
Vcm_AISkills_East_aimingSpeed = 0.2;
Vcm_AISkills_East_commanding = 0.3;
Vcm_AISkills_East_courage = 0.3;
Vcm_AISkills_East_general = 0.3;
Vcm_AISkills_East_reloadSpeed = 0.2;
Vcm_AISkills_East_spotDistance = 0.2;
Vcm_AISkills_East_spotTime = 0.2;

// VCOM AI General Skill
Vcm_AISkills_General_AimingAccuracy = 0.2;
Vcm_AISkills_General_aimingShake = 0.2;
Vcm_AISkills_General_aimingSpeed = 0.2;
Vcm_AISkills_General_commanding = 0.3;
Vcm_AISkills_General_courage = 0.3;
Vcm_AISkills_General_general = 0.3;
Vcm_AISkills_General_reloadSpeed = 0.2;
Vcm_AISkills_General_spotDistance = 0.2;
Vcm_AISkills_General_spotTime = 0.2;

// VCOM AI Resistance Skill
Vcm_AISkills_Resistance_AimingAccuracy = 0.2;
Vcm_AISkills_Resistance_aimingShake = 0.2;
Vcm_AISkills_Resistance_aimingSpeed = 0.2;
Vcm_AISkills_Resistance_commanding = 0.3;
Vcm_AISkills_Resistance_courage = 0.3;
Vcm_AISkills_Resistance_general = 0.3;
Vcm_AISkills_Resistance_reloadSpeed = 0.2;
Vcm_AISkills_Resistance_spotDistance = 0.2;
Vcm_AISkills_Resistance_spotTime = 0.2;

// VCOM AI West Skill
Vcm_AISkills_West_AimingAccuracy = 0.5;
Vcm_AISkills_West_aimingShake = 0.5;
Vcm_AISkills_West_aimingSpeed = 0.5;
...
force VCM_USECBASETTINGS = false;
